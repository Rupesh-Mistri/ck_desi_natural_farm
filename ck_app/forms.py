...
class MemberRegistrationForm(forms.ModelForm):
    ...
    class Meta:
        model = MemberModel
        fields = [
            'senior_ID', 'senior_Name',  'applicant_name','phone_number','email',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['email'].required = False  # make field optional
    ...
    def save(self, commit=True):
        ...
        if last_member and last_member.id:
            new_member_id = f"CKDNF{last_member.id + 1:06d}"
        else:
            new_member_id = "CKDNF000001"
